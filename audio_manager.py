...
class DialogSession:
    ...
    def __init__(
        ...
        # === ctrl.txt 变更监控 & 特殊句 ASR 模式 ===
        self.ctrl_path = "ctrl.txt"
        self._ctrl_last_content: str = ""
        self._capture_next_sentence_for_asr: bool = False
        self._special_sentence_buffer: bytes = b""
